...
####Feedback would be appreciated about how to use map to loop through each numeric column within the nested data (d2) ----- AGI: look at bottom for a way to do this, starting in line 289 to 315
...
descriptives <- function(df) {
  select_numeric <- only_numeric(df) # this function is the one in line 291
